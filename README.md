...
[![Test Action](https://github.com/Appsilon/bioc-check-action/actions/workflows/test-action.yaml/badge.svg)](https://github.com/Appsilon/bioc-check-action/actions/workflows/test-action.yaml)
